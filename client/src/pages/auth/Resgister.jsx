                ...
                <Form layout="vertical" onFinish={onFinish}>
                 ...
                 <Form.Item>
                  ...
                  <Button type="primary"
                   ...
                   className="w-full" 
                   loading={loading}
                  size="large">Kaydol</Button>
                 </Form.Item>                 
                </Form>

                <div className="flex justify-center absolute left-0 bottom-10 w-full" >Bir Hesabınız varsa şimdi&nbsp;<Link className="text-blue-600" to={"/login"} >Giriş yapabilirsiniz..</Link></div>
            </div>
        </div>
