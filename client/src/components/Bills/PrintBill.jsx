          ...
          <div className="max-w-5xl mx-auto bg-white px-6">
            <article className="overflow-hidden">
              <div className="logo my-6">
                <h2 className="text-4xl font-bold text-slatte-700">LOGO</h2>
              </div>
              ...
              <div className="bill-table-area mt-8">
                <table className="min-w-full divide-y divide-slate-500 overflow-hidden">
                    ...
                    <tr className=" border-slate-200">
                      ...
                      <th
                        ...
                        className="py-3.5  text-left text-sm font-normal
                         text-slate-700 sm:table-cell hidden md:pl-0 "
                      >
                        Başlık{" "}
                      </th>
                      <th
                        ...
                        colSpan={4}
                        className="py-3.5  text-left text-sm font-normal
                         text-slate-700 sm:hidden md:pl-0 "
                      >
                        Başlık{" "}
                      </th>
                      <th
                  ...
                  <tfoot >
                    <tr>
                        ...
                        <th className="text-right pt-4 " scope="row"> <span className="font-normal text-slate-700" >
                        {customer?.subTotal} 
                        </span>
                         </th>                         
                    </tr>
                    ...
                    <th className="text-right pt-4 sm:table-cell hidden" colSpan="4" scope="row"> 
                        ...
                        <th className="text-right pt-4" scope="row"> <span className="font-normal text-red-600" >
                        {customer?.tax} 
                        </span> </th>                        
                    </tr>
                    <tr>
                ...
                <div className="py-9"> 
                <div className="border-t pt-9 border-slate-100">
